...
class GameTest {
    ...
    void example_solve_solved() {
        String input = """
                ...
                .....
                                """;
        assertEquals(cut.parse(input, 'F').solve(), 4);
    }

    @Test
    void example2_solve_solved() {
        ...
        String input = """
                ...
                LJ...
                """;
        assertEquals(cut.parse(input, 'F').solve(), 8);
    }
    ...
    void challenge_solve_solved() {
        ...
        String input = """
                ...
                """;
        assertEquals(cut.parse(input, '|').solve(), 8);
    }
}