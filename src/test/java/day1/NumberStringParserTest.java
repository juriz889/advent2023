...
class NumberStringParserTest {
    private NumberStringParser cut;

    @BeforeEach
    void setUp() {
        cut = new NumberStringParser();
    }

    @Test
    void oneLine_parse_result() {
        String input = "two1nine\n";
        assertEquals(29, cut.parse(input));
    }
    @Test
    void oneLineThreeNumbers_parse_result() {
        String input = "eightwothree\n";
        assertEquals(83, cut.parse(input));
    }
    @Test
    void oneOtherLineThreeNumbers_parse_result() {
        String input = "4nineeightseven2\n";
        assertEquals(42, cut.parse(input));
    }

    @Test
    void example_parse_result() {
        String input = "two1nine\n" +
                "eightwothree\n" +
                "abcone2threexyz\n" +
                "xtwone3four\n" +
                ...
                "zoneight234\n" +
                "7pqrstsixteen";
        assertEquals(281, cut.parse(input));
    }

    @Test
    void challenge_parse_result() {
        String input = "29lzrxseven\n" +
                "9nnqljsixkzphvtmtr\n" +
        ...
        assertEquals(55834, cut.parse(input));
    }
}