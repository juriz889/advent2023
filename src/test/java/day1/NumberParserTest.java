...
class NumberParserTest {
    ...
    void oneLine_parse_result() {
        String input = "1abc2";
        assertEquals(12, cut.parse(input));
    }
    @Test
    void oneLineMany_parse_result() {
        String input = "395fiveqqjqrkxxrbseven6sevenncnnpzffj\n";
        assertEquals(37, cut.parse(input));
    }
    @Test
    void example_parse_result() {
        String input = "1abc2\n" +
                ...
                "a1b2c3d4e5f\n" +
                "treb7uchet";
        assertEquals(142, cut.parse(input));
    }
    ...
    void challenge_parse_result() {
        ...
        NumberStringParser cut = new NumberStringParser();
