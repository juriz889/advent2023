...
class SolverTest {
    ...
    void sample_solve_solved() {
        ...
        String input = """
                ...
                GGG = (GGG, GGG)
                ZZZ = (ZZZ, ZZZ)""";
        assertEquals(2, cut.solve(directions, input));
    }

    @Test
    void sample2_solve_solved() {
        String directions = "LLR" ;
        String input = """
                AAA = (BBB, BBB)
                BBB = (AAA, ZZZ)
                ZZZ = (ZZZ, ZZZ)""";
        assertEquals(6, cut.solve(directions, input));
    }

    @Test
    void challenge_solve2_solved() {
        ...
        String input = """
                ...
                XVQ = (PCQ, PCQ)
                JPR = (LVV, GNP)""";
        assertEquals(14893, cut.solve(directions, input));
    }
    @Test
    void challenge_solvePart2_solved() {
        String directions = "" ;
        String input = """
                QKX = (SQD, XTJ)
                FKP = (JGJ, JPR)
                ...
                XVQ = (PCQ, PCQ)
                JPR = (LVV, GNP)""";
        assertEquals(14893, cut.solvePart2(directions, input));
    }
}