...
class GameSolverTest {
    private GameSolver cut;

    @BeforeEach
    void setUp() {
        cut = new GameSolver(new Config(Map.of(Color.RED, 12, Color.GREEN, 13, Color.BLUE, 14)));
    }

    @Test
    void inputGiven_solve_solve() {
        ...
        int solvedGame = cut.getSolvedGame(input);
        assertEquals(solvedGame, 8);
    }
    @Test
    void inputGiven_solvePart2_solve() {
        String input = "Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green\n" +
                "Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue\n" +
                "Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red\n" +
                "Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red\n" +
        ...
        int solvedGame = cut.getSolvedGamePart2(input);
        assertEquals(solvedGame, 2286);
    }

    @Test
    public void game_sovle() {
        String input = """
        ...
        assertEquals(cut.getSolvedGame(input), 1867);
    }
    @Test
    public void game_sovle2() {
        String input = """
                Game 1: 5 red, 1 green; 6 red, 3 blue; 9 red; 1 blue, 1 green, 4 red; 1 green, 2 blue; 2 blue, 1 red
                Game 2: 12 red, 2 green, 9 blue; 8 red, 12 blue; 9 red, 1 blue, 2 green; 12 blue, 8 red, 2 green; 4 red, 5 blue; 1 green, 9 blue, 10 red
                Game 3: 2 red, 8 blue, 5 green; 10 red, 10 green, 7 blue; 9 green, 13 red, 5 blue
                ...
                Game 99: 4 blue; 1 red, 2 green, 11 blue; 12 blue, 1 green, 1 red; 11 blue, 6 green; 1 red, 7 green, 8 blue
                Game 100: 10 blue, 5 green; 4 green, 3 red, 6 blue; 2 green, 4 red, 1 blue""";
        assertEquals(cut.getSolvedGamePart2(input), 84538);
    }
}